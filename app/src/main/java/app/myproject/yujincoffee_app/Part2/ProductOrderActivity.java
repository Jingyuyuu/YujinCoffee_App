                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if((binding.productQuantity.getText().toString()!=null) && !(binding.productQuantity.getText().toString()).equals("")) {
                            try {
                                ...
                                if(shopAmount>0) {
                                    if (shopTem > 0) {
                                        if (shopSugar != null && !shopSugar.equals("") && shopIce != null && !shopIce.equals("")) {
                            ...
                            Toast.makeText(ProductOrderActivity.this, "數量不能是空的", Toast.LENGTH_SHORT).show();
                        }
